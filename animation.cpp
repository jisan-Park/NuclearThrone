...
HRESULT animation::init(string strKey)
{
	_frameWidth = IMAGEMANAGER->findImage(strKey)->getFrameWidth();
	int _frameNumWidth = IMAGEMANAGER->findImage(strKey)->getWidth() / _frameWidth;

	_frameHeight = IMAGEMANAGER->findImage(strKey)->getFrameHeight();
	int _frameNumHeight = IMAGEMANAGER->findImage(strKey)->getHeight() / _frameHeight;
